...
namespace March5.Controllers
{
    public class SuggestionModelsController : Controller
    {
        private March5Context db = new March5Context();
        ...
        public ActionResult Create([Bind(Include = "RecordNum,Movie,MovieStar,ReviewStars")] SuggestionModel suggestionModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RecordNum,Movie,MovieStar,ReviewStars")] SuggestionModel suggestionModel)
        {
            if (ModelState.IsValid)
            {
